 ...
 */
define ('PDF_HEADER_LOGO', 'http://certidaodigital.jucems.ms.gov.br/sisdap/images/loginLogo.png');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'ESTADO DE MATO GROSSO DO SUL');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "\nSECRETARIA DE ESTADO DE DESENVOLVIMENTO AGÁRIO, DA PRODUÇÃO, DA INDÚSTRIA, DO COMÉRCIO E DO TURISMO - SEPROTUR"
        . " \n\r\n\rJUNTA COMERCIAL DO ESTADO DE MATO GROSSO DO SUL - JUCEMS");
